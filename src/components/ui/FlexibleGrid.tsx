...
export default class FlexibleGrid extends React.PureComponent<FlexibleGridProps,
    State> {
    state = {
        itemWidth: 0,
        containerWidth: 0,
    ...
    onDimensionsChange(dimensions: Dimensions) {
        ...
        Log.info('[FLEXIBLE-GRID]', 'onDimensionsChange', width, containerWidth, itemWidth, itemMargin);
    }
