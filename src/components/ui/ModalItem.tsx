...
import {Animated, LayoutChangeEvent, TextStyle, ViewStyle} from 'react-native';
...
export default class ModalItem extends BaseComponent<ModalItemProps,
    State> {
    state = {
    ...
    loadStyles(theme: ThemeVars) {
        return {
            ...
            backdrop: {
                backgroundColor: theme.modalItemBackgroundColor,
                zIndex: 9,
                //flex: 1,
            ...
            content: {
                margin: 10,
                backgroundColor: theme.modalItemContentBackgroundColor,
                borderRadius: 4,
            ...
            title: {
                fontSize: 14,
                fontWeight: 'bold',
                color: theme.modalItemTextColor
            } as TextStyle,
            header: {
                padding: 20
            } as ViewStyle,
            body: {
                borderTopWidth: 1,
                borderTopColor: theme.modalItemBorderColor
            } as ViewStyle,
            bodyText: {
                padding: 5
            } as TextStyle,
