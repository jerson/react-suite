...
import {Animated, LayoutChangeEvent, StyleSheet, TextStyle, TouchableWithoutFeedback, ViewStyle} from 'react-native';
...
export default class ModalActionItem extends React.PureComponent<ModalActionItemProps,
    State> {
    state = {
